...
local function readPicasaIni(folder, keywords)
...
local function createKeywords(contacts, synonyms)
  local root
...
local function locateFolder(folderName, folders)
